...
public class InvalidOldPasswordErrorCode2ThrowableConverter implements ErrorCode2ThrowableConverter {
    @Override
    ...
    public String getSupportedErrorCode() {
        return AuthenticationErrorCodes.INVALID_OLD_PASSWORD;
    }
}
