...
@Value
public class TrackPlayedEvent extends AbstractEvent<TrackPlayedPayload> {
    public static final String EVENT_TYPE = "track_played";

    public TrackPlayedEvent(final TrackPlayedPayload body) {
        super(body);
    }

    @JsonCreator
    public TrackPlayedEvent(final String id,
